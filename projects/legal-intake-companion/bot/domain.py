...
TITLE = "Ассистент первичного юридического приёма"
ENTITY = "обращение"
OPERATOR = "координатор практики"
METRIC = "скорость первичной сортировки и доля консультаций"
DISPLAY_MAP = {
    "customer": "клиент",
    "operator": "оператор",
    "warehouse": "склад",
