...
TITLE = "Бот онбординга партнёров"
ENTITY = "партнерский запуск"
OPERATOR = "партнерский менеджер"
METRIC = "скорость вывода партнера в запуск"
DISPLAY_MAP = {
    "customer": "клиент",
    "operator": "оператор",
    "warehouse": "склад",
...
RISKS = [
    ...
    "долгая интеграция",
    "высокий потенциал регулярной выручки"
]
